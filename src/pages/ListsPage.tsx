        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <header className="mb-8">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Curate collections of shows you love and share them with the
              community.
            </p>
          </header>
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-sm mt-1 text-muted-foreground max-w-sm">
              Build collections of your favorite shows, keep track of what you
              want to watch, and share recommendations with others.
            </p>
            ...
            <Dialog open={createOpen} onOpenChange={setCreateOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Group your favorite shows into a collection you can revisit
                    and share.
                  </DialogDescription>
                </DialogHeader>
