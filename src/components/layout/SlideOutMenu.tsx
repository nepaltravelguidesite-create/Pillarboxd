...
const MENU_ITEMS = [
  ...
  { to: "/profile/reviews", icon: Star, label: "Reviews", end: true },
  { to: "/profile/watchlist", icon: Bookmark, label: "Watchlist", end: true },
  { to: "/lists", icon: List, label: "Lists", end: true },
  { to: "/profile/likes", icon: Heart, label: "Likes", end: true },
